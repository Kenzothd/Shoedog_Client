...
function SingleProfile() {
  ...
  return (
    <div className="my-[10rem] mx-[14rem] flex flex-col gap-8">
      <div className="flex flex-start gap-12 items-center px-6">
      ...
      <div className="flex items-center justify-between font-medium px-6">
      ...
      <div id="tab" className="flex gap-5 font-semibold border-b-2 text-lg">
        {tabs.map((e, i) => (
          <button
