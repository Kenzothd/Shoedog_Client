...
function Alerts({ userId }: Props) {
  return (
    <div className="border-2 rounded">
      ...
      <div className="grid grid-cols-7 gap-1.5 items-center text-center  border-b">
      ...
      <div className="h-80 overflow-auto">
        <div className="grid grid-cols-7 items-center text-center py-1 pl-2 border-b text-[12px] ">
          <div className="col-span-4 flex justify-center items-center gap-0.5 text-sm">
            <img
